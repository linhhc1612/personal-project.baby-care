...
export const YoutubeIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ArrowLeftIcon = ({ width = '1.4rem', height = '1.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SliderIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CartIcon2 = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const WishListIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        ...
        height={height}
        fill="currentColor"
        enableBackground="new 0 0 412.735 412.735"
...
export const WishListActiveIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
