...
function HeaderTop() {
    ...
    return (
        <div className={cx('row justify-content-between px-web py-2 border-bottom')}>
            ...
            <div className={cx('col-lg-3 col-md-12 col-7')}>
                <marquee>
                    {marquees.map((result) => (
            ...
            <div className={cx('col-lg-4 col-md-6 text-end')}>
